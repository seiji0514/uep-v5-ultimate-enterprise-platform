...
async def get_traffic_management(
    ...
    """交通管理一覧を取得"""
    return {
        "items": _traffic_management_list(),
        "total": len(_traffic_management_list()),
    }
...
async def get_air_traffic_control(
    ...
    """航空管制一覧を取得"""
    return {
        "items": _air_traffic_control_list(),
        "total": len(_air_traffic_control_list()),
    }
