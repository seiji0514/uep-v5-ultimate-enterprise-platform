...
class PerformanceOptimizer:
    ...
    def get_metrics(self, endpoint: str) -> Optional[PerformanceMetrics]:
        ...
        return PerformanceMetrics(
            ...
            p95_response_time=response_times[p95_index] if p95_index < len(response_times) else avg,
            p99_response_time=response_times[p99_index] if p99_index < len(response_times) else avg,
