    ...
    return [
        {
            ...
            "saving_estimate": 12000,
            "action": "リザーブドインスタンス検討",
            "priority": "高",
        },
        {
            "id": "opt-002",
        ...
        },
        {
            ...
            "saving_estimate": 8000,
            "action": "VPC Endpoint検討",
            "priority": "高",
        },
        {
            "id": "opt-006",
            "type": "FinOps",
            "resource": "Lambda-Provisioned",
            "saving_estimate": 3500,
            "action": "Provisioned Concurrency見直し",
            "priority": "低",
        },
        {
            "id": "opt-007",
            ...
            "saving_estimate": 6000,
            "action": "ノードタイプダウングレード検討",
            "priority": "中",
        },
    ]
...
async def get_orchestration():
    return {
        "items": _orchestration_deployments(),
        "total": len(_orchestration_deployments()),
    }
...
async def get_optimization():
    return {
        "items": _optimization_recommendations(),
        "total": len(_optimization_recommendations()),
    }
...
async def get_dashboard():
    return {
        ...
        "optimization_savings": sum(
            r["saving_estimate"] for r in _optimization_recommendations()
        ),
    }
