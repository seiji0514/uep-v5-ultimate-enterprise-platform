...
async def get_dashboard():
    return {
        ...
        "pipelines_running": len(
            [p for p in _data_pipelines() if p["status"] == "実行中"]
        ),
    }
